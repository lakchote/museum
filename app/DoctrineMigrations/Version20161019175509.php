...
class Version20161019175509 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE billet (id INT AUTO_INCREMENT NOT NULL, commande_id INT NOT NULL, tarif_id INT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, pays VARCHAR(255) NOT NULL, is_tarif_reduit TINYINT(1) NOT NULL, date_naissance DATE NOT NULL, INDEX IDX_1F034AF682EA2E54 (commande_id), INDEX IDX_1F034AF6357C0A59 (tarif_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
